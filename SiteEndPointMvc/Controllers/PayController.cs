    ...
    public class PayController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
           ...
           var requestPay=  _addRequestPayService.Execute(cart.Data.SumAmount, UserId.Value);
                ...
                {
                    Mobile = "09121112222",
                    CallbackUrl = $"https://localhost:44300/Pay/Verify?guid={requestPay.Data.guid}",
        ...
        public async Task<IActionResult> Verify(Guid guid, string authority, string status)
        {
            ...
            //اگر متد بالایی کار نکرد
            //var client = new RestClient("hts://www.zarinpal.com/pg/rest/WebGate/PaymentVerification.json");
            //client.Timeout = -1;
